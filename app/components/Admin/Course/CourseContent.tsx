...
import { MdOutbond, MdOutlineKeyboardArrowDown } from "react-icons/md";
...
const CourseContent: FC<Props> = ({
  ...
  return (
    <div className="w-[80%] m-auto mt-[100px]  p-3">
      <form onSubmit={handleSubmit}>
                  ...
                  <>
                    <div className="my-3">
                      ...
                      <input
                        ...
                        placeholder="Please write the title of Video"
                        value={item.title}
                        onChange={(e) => {
                          const updatedData = [...courseContentData];
                          updatedData[index] = {
        ...
        >
          <AiOutlinePlusCircle className="mr-2" /> Add a new Section
        </div>
      </form>
      <br />
      <div className="w-full flex items-center justify-between">
