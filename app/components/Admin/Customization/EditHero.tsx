  ...
  return (
    <>
      <div className="w-full 1000px:flex items-center dark:text-white text-black">
        ...
        <div className="1000px:w-[40%] flex 1000px:min-h-screen  items-center justify-end pt-[70px] 1000px:pt-[0] z-10  ">
          <div className="relative flex items-center justify-end ">
            ...
            <label htmlFor="banner" className="absolute bottom-0 right-0 z-20">
              <AiOutlineCamera className="dark:text-white text-black text-[18px] cursor-pointer" size={35} />
            </label>
          </div>
        ...
        <div className="1000px:w-[60%] flex flex-col items-center 1000px:mt-[0px] text-center 1000px:text-left mt-[150px] font-[18px]">
        <textarea
        className="dark:text-white resize-none text-[#000000c7] text-[18px] px-3 w-full 1000px:text-[20px] 1500px:text-[25px] font-Poppins border border-black dark:border-white "
        placeholder="We have many courses to help you learn better."
        value={title}
