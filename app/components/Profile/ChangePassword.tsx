      ...
      <div className="w-full">
        ...
        >
          <div className="w-[100%] 800px:w-[60%] mt-5">
            ...
            <input
              type="password"
              className={`${styles.input} !w-[95%] mb-4 800:pxmb-0 text-black ddark:text-white`}
              required
              value={oldPassword}
          ...
          <div className="w-[100%] 800px:w-[60%] mt-2">
            ...
            <input
              type="submit"
              className={`w-[95%] h-[40px] border border-[#37a39a] text-center dark:text-[#fff]  text-black bg-blue-200 rounded-[3px] mt-8 cursor-pointer `}
              required
              value="Update"
            />
          </div>
