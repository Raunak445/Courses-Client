...
const ProfileInfo: FC<Props> = ({ avatar, user }) => {
  ...
  const handleSubmit = async (e: any) => {
    // console.log("submit");
    //prevents from submiting the form and reloading the page
    e.preventDefault()
        ...
        <div className="w-full pl-6 800px:pl-10">
          <form onSubmit={handleSubmit}>
            <div className="800px:w-[50%] m-auto block pb-4">
              ...
              <input
                className={`w-full 800px:w-[250px] h-[40px] border border-[#37a39] text-center dark:text-[#fff] text-black bg-blue-400 rounded-[3px] mt-8 cursor-pointer`}
                required
                value="Update"
                type="submit"
              />
