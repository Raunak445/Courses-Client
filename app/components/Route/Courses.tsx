import { useGetAllCoursesQuery, useGetUsersAllCourseQuery } from "@/redux/features/courses/coursesApi";
    ...
    <div>
      <div className={`w-[90%] 800px:w-[80%] m-auto  `}>
        <h1 className="text-center font-Poppins 800px:text-[25px] leading-[35px] sm:text-3xl lg:text-4xl dark:text-white 800px:!leading-[60px] text-black font-[700] tracking-tight">
          <span className="text-gradient">Expand your carrer Opportunity </span> <br />
         With Our Courses
        </h1>
        <br />
        <br />
